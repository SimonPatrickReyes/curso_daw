  ...
  return (
    <div className='container mt-4'>
      ...
      <div className='row mt-2'>
            ...
            {tareas.map((item, index) => (
              ...
              >
                ...
                <div className='d-flex justify-content-end align-items-center'>
                  ...
                  <button className='btn btn-warning me-2 btn-sm float-end' onClick={() => activarModoEdicion(item)}>
                    Editar
                  </button>
                  <button
        ...
        <div className='col-4'>
          <h4 className='text-center'>{modoEdicion ? 'Editar tarea' : 'Agregar tareas'}</h4>
          <form onSubmit={modoEdicion ? editar:agregarTarea}>
            ...
            {ModoEdicion ? (
              ...
              <button className='btn btn-dark w-100 mt-2'>{modoEdicion ? 'Guardar cambios' : 'Agregar'}</button>)}
          </form>
        </div>
      </div>
    </div>
